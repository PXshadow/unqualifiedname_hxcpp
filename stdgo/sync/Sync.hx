...
@:structInit @:private @:using(stdgo.sync.Sync.T_poolChainElt_static_extension) class T_poolChainElt {
    ...
    **/
    ...
    @:embedded
    public function _pushHead(_key:AnyInterface):Bool return false;
    @:embedded
...
@:keep @:allow(stdgo.sync.Sync.T__struct_42_asInterface) class T__struct_42_static_extension {

}
@:local @:using(stdgo.sync.Sync.T__struct_42_static_extension) private typedef T__struct_42 = {};
/**
...
class T_poolChainElt_asInterface {
    ...
    @:embedded
    public dynamic function _pushHead(_key:AnyInterface):Bool return __self__.value._pushHead(_key);
    @:embedded
    public dynamic function _popTail():{ var _0 : AnyInterface; var _1 : Bool; } return __self__.value._popTail();
    @:embedded
    public dynamic function _popHead():{ var _0 : AnyInterface; var _1 : Bool; } return __self__.value._popHead();
...
@:keep @:allow(stdgo.sync.Sync.T_poolChainElt_asInterface) class T_poolChainElt_static_extension {
    ...
    @:embedded
    public static function _pushHead( __self__:T_poolChainElt, _key:AnyInterface):Bool return __self__._pushHead(_key);
    @:embedded
