...
**/
private var _getwdCache : T__struct_48 = ({ mutex : ({} : stdgo.sync.Sync.Mutex), _dir : ("" : GoString) } : T__struct_48);
/**
...
@:keep @:allow(stdgo.os.Os.T__struct_48_asInterface) class T__struct_48_static_extension {
    @:embedded
    public static function _unlockSlow( __self__:T__struct_48, __0:GoInt32) null;
    @:embedded
    public static function _lockSlow( __self__:T__struct_48) null;
    @:embedded
    public static function unlock( __self__:T__struct_48) null;
    @:embedded
    public static function tryLock( __self__:T__struct_48):Bool return return false;
    @:embedded
    public static function lock( __self__:T__struct_48) null;
}
@:local @:using(stdgo.os.Os.T__struct_48_static_extension) private typedef T__struct_48 = {
    @:embedded
