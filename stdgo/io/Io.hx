...
@:keep @:allow(stdgo.io.Io.T__struct_47_asInterface) class T__struct_47_static_extension {

}
@:local @:using(stdgo.io.Io.T__struct_47_static_extension) private typedef T__struct_47 = {};
/**
