...
**/
final intArgRegs = (0i64 : GoUInt64);
/**
...
**/
final floatArgRegs = (0i64 : GoUInt64);
/**
...
**/
final effectiveFloatRegSize = (0i64 : GoUInt64);
/**
...
@:structInit @:using(stdgo.internal.abi.Abi.RegArgs_static_extension) class RegArgs {
    ...
    **/
    public var returnIsPtr : stdgo.internal.abi.Abi.IntArgRegBitmap = new stdgo.internal.abi.Abi.IntArgRegBitmap(...[for (i in 0 ... 0) (0 : GoUInt8)]);
    public function new(?ints:GoArray<GoUIntptr>, ?floats:GoArray<GoUInt64>, ?ptrs:GoArray<stdgo.unsafe.Unsafe.UnsafePointer>, ?returnIsPtr:stdgo.internal.abi.Abi.IntArgRegBitmap) {
...
**/
@:named @:using(stdgo.internal.abi.Abi.IntArgRegBitmap_static_extension) typedef IntArgRegBitmap = GoArray<GoUInt8>;
/**
...
**/
function funcPCABI0(_f:AnyInterface):GoUIntptr throw "not implemented: funcPCABI0";
/**
    ...
    // Implemented as a compile intrinsic.
**/
function funcPCABIInternal(_f:AnyInterface):GoUIntptr throw "not implemented: funcPCABIInternal";
class RegArgs_asInterface {
    ...
    **/
    @:keep
    public dynamic function intRegArgAddr(_reg:GoInt, _argSize:GoUIntptr):stdgo.unsafe.Unsafe.UnsafePointer return __self__.value.intRegArgAddr(_reg, _argSize);
    @:keep
...
@:keep @:allow(stdgo.internal.abi.Abi.RegArgs_asInterface) class RegArgs_static_extension {
    ...
    **/
    ...
    static public function intRegArgAddr( _r:Ref<RegArgs>, _reg:GoInt, _argSize:GoUIntptr):stdgo.unsafe.Unsafe.UnsafePointer {
        if (((_argSize > (4 : GoUIntptr)) || (_argSize == (0 : GoUIntptr))) || ((_argSize & (_argSize - (1 : GoUIntptr))) != (0 : GoUIntptr))) {
            throw Go.toInterface(("invalid argSize" : GoString));
        };
        var _offset:GoUIntptr = (0 : GoUIntptr);
        if (false) {
            _offset = (4 : GoUIntptr) - _argSize;
        };
        return (Go.toInterface((((Go.toInterface(Go.pointer(_r.ints[(_reg : GoInt)])) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind)) : GoUIntptr) + _offset)) : stdgo.unsafe.Unsafe.UnsafePointer);
    }
    @:keep
...
class IntArgRegBitmap_asInterface {
    ...
    **/
    @:keep
    public dynamic function get(_i:GoInt):Bool return __self__.value.get(_i);
    /**
        // Set sets the i'th bit of the bitmap to 1.
    **/
    @:keep
    public dynamic function set(_i:GoInt):Void __self__.value.set(_i);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.internal.abi.Abi.IntArgRegBitmap_asInterface) class IntArgRegBitmap_static_extension {
    ...
    **/
    ...
    static public function get( _b:Ref<IntArgRegBitmap>, _i:GoInt):Bool {
        return _b[(_i / (8 : GoInt) : GoInt)] & (((1 : GoUInt8) : GoUInt8) << (_i % (8 : GoInt))) != ((0 : GoUInt8));
    }
    /**
        // Set sets the i'th bit of the bitmap to 1.
    **/
    ...
    static public function set( _b:Ref<IntArgRegBitmap>, _i:GoInt):Void {
        _b[(_i / (8 : GoInt) : GoInt)] = _b[(_i / (8 : GoInt) : GoInt)] | (((1 : GoUInt8) : GoUInt8) << (_i % (8 : GoInt)));
    }
}
